...
// Client interface abstracts the Sense client functionality to facilitate testing
...
func NewCollector(ctx context.Context, client Client, monitor int, timeout time.Duration) *Collector {
	return &Collector{
		ctx:     ctx,
		cl:      client,
		timeout: timeout,
